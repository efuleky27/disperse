...
python scripts/ndtopo_stats.py \
  --delaunay-ndnet <Delaunay.vtu|NDnet> \
  --walls-ndnet <Walls.vtu|NDnet> \
  --filaments-ndskl <Filaments.vtp|NDskl> \
...
python scripts/ndtopo_stats.py --verbose \
  --delaunay-ndnet outputs/snap_010_cropped_test/snap_010_nosmooth.vtu \
  --walls-ndnet    outputs/snap_010_cropped_test/snap_010_s3_manifolds_JE1a_nosmooth.vtu \
  --filaments-ndskl outputs/snap_010_cropped_test/snap_010_s3.U_nosmooth.S000.vtp \
...
python scripts/ndtopo_stats.py --verbose --write-vtk \
  ...
  --filaments-ndskl outputs/snap_010_cropped_test/snap_010_s3.U.NDskl \
