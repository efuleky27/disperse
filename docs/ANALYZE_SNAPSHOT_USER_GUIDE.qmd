...
- Manifolds (walls): `<prefix>_sX_manifolds_<TAG>.S###.vtu` (NDnet: `<prefix>_sX_manifolds_<TAG>.NDnet`).
- Filament manifolds (optional): `<prefix>_sX_filament_manifolds_<TAG>.S###.vtu` (NDnet from `mse`: `<prefix>_sX_manifolds_<TAG>.NDnet`).
