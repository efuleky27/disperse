...
ParaView-friendly workflow using the outputs we already have (`snap_010_manifolds_vtu_JE1a_smooth20_S020.vtu` for walls and `snap_010_arcs_U_vtp_smooth20_S020.vtp` for filaments). Goal: take a slab of given thickness, project to 2D, keep a type tag, and color by type.
